...
notes[9].hammer.K = 173035859.4781704800000000;
notes[9].hammer.fsh = 44100;
notes[9].hammer.m = 0.0137738829838603;
notes[9].hammer.p = 2.1034175411138261;
notes[9].string.Min = 10;
notes[9].string.Mup = 239;
notes[9].string.Mlow[0] = 230;
notes[9].string.fs = 22050;
notes[9].string.Z = 5.7577855962391080;
notes[9].string.tau = 0.9971252452572431;
notes[9].string.Ref = 0.0028747547427569;
notes[9].LP[0].glp = 0.7496321683986990;
notes[9].LP[0].a1 = -0.2434904722581937;
notes[9].tunning[0].a1 = 0;
notes[9].allpass.a1 = -0.9523651388530088;
notes[9].allpass.a2 = 0.9077084297483382;
notes[9].Ns = 1;
notes[9].M = 4;
notes[9].control.MaxV = 20;
notes[9].control.MinV = 1;
notes[9].control.scale = 1;
...
// D4
	...
	notes[41].hammer.K = 2502125417.4678874000000000;
	notes[41].hammer.fsh = 88200;
	notes[41].hammer.m = 0.0062047046808842;
	notes[41].hammer.p = 2.4711541538200104;
	notes[41].string.Min = 11;
	notes[41].string.Mup = 76;
	notes[41].string.Mlow[0] = 73;
	notes[41].string.Mlow[1] = 72;
	notes[41].string.Mlow[2] = 70;
	notes[41].string.fs = 44100;
	notes[41].string.Z = 3.7498457924108410;
	notes[41].string.tau = 0.9981268331255253;
	notes[41].string.Ref = 0.0018731668744747;
	notes[41].LP[0].glp = 0.7530000000000000;
	notes[41].LP[0].a1 = -0.2434904722581937;
	notes[41].LP[1].glp = 0.7530000000000000;
	notes[41].LP[1].a1 = -0.2434904722581937;
	notes[41].LP[2].glp = 0.7530000000000000;
	notes[41].LP[2].a1 = -0.2434904722581937;
	notes[41].tunning[0].a1 = 0.3841584190750141;
	notes[41].tunning[1].a1 = 0.4792999714928149;
	notes[41].tunning[2].a1 = 0.4256179688168330;
	notes[41].allpass.a1 = -0.9541164611967574;
	notes[41].allpass.a2 = 0.9109977019476747;
	notes[41].Ns = 3;
	notes[41].M = 4;
	notes[41].control.MaxV = 4.5;
	notes[41].control.MinV = 2;
	notes[41].control.scale = 0.5;
